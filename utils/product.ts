export const product = {
  ...
  price: 40,
  brand: "Elite Canvas Australia",
  category: "Prints",
  options: [
    { value: "stretched", label: "Stretched Canvas" },
    { value: "framedPhoto", label: "Framed Photo Prints" },
    { value: "floating", label: "Floating Frame Canvas" },
  ],
  stretchedSizes: ["20x30cm", "30x40cm", "60x90cm", "90x120cm"],
  floatingFramed: ["20x30cm", "30x40cm", "60x90cm"],
